...
public class DecrementPosition extends CommandBase {
  ...
  public void execute() {
    if (component.equals("rotate")) {
      if (ArmControl.rotateTarget > AC.ROT_FOUR) {
        ArmControl.rotateTarget = AC.ROT_FOUR;
      } else if (ArmControl.rotateTarget <= AC.ROT_FOUR
      ...
      if (ArmControl.extendTarget > AC.EXT_FOUR) {
        ArmControl.extendTarget = AC.EXT_FOUR;
      } else if (ArmControl.extendTarget <= AC.EXT_FOUR
