...
public class BackTrack extends CommandBase {
  ...
  @Override
  public void execute() {
    if (RobotContainer.m_drive.pitchValue > DC.MAXSECONDARYBALANCE){
      RobotContainer.m_drive.tankDriveVolts(-DC.SECONDARYBALANCESPEED, -DC.SECONDARYBALANCESPEED); // Drive backward
