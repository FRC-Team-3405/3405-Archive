...
public class Camera extends Subsystem {
    ...
    public Camera() {
        ...
        criteria.addCriteria(NIVision.MeasurementType.IMAQ_MT_AREA, 150, 65535, false);
    ...
    public ColorImage takeSnapshot() {
    ...
    public TargetReport locateTarget() {
        BinaryImage thresholdImage = null;
        BinaryImage processedImage = null;
        ColorImage snapshot = null;
        ...
        try {
            ...
            thresholdImage = snapshot.thresholdHSV(105, 137, 230, 255, 133, 183);
            processedImage = thresholdImage.particleFilter(criteria);

            report = scoreImage(processedImage);
            ...
            if (thresholdImage != null) try {
                thresholdImage.free();
            } catch (NIVisionException ex) {
                ex.printStackTrace();
            }
            
            if (processedImage != null) try {
                processedImage.free();
            } catch (NIVisionException ex) {
                ex.printStackTrace();
            }           
    ...
    private TargetReport scoreImage(BinaryImage filteredImage) throws NIVisionException {
